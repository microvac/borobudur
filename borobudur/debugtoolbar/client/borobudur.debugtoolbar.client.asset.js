 ...
 */
(function (prambanan){
    var main = function (app_name, app, loaded_assets, handler_type_id) {
        ...
        var Live = {
            ...
            loadResources:function () {
                changesAPI = "/_debug_toolbar_borobudur/assets/changed/"
                listAPI = "/_debug_toolbar_borobudur/assets/list/"
                resources = loaded_assets;
                ...
                var cssPacks = loaded_assets.css;
            ...
            checkForChanges:function () {
                ...
                $.getJSON(changesAPI +app_name +"/" + handler_type_id, function (data) {
                    if (active.js) {
                        if (data.js.length > 0) {
            ...
            refreshResource:function (type, name) {
                switch (type.toLowerCase()) {
                    ...
                    case "css":
                        $.getJSON(listAPI +app_name +"/"+ handler_type_id, function (data) {
        ...
        function assetLoaded() {
            ...
            var html = "";
            html += template({assets:loaded_assets, type:'js'})
            html += template({assets:loaded_assets, type:'css'})
    ...
    prambanan.exports('borobudur.debugtoolbar.client.asset', {main: main});
})(prambanan);
